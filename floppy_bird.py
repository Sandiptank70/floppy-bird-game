...
GAME_SPRITES = {}
GAME_SOUNDS = {}
PLAYER = 'gallary/sprites/bird1.png'
...
if __name__ == "__main__":
    ...
    GAME_SPRITES['message'] = pygame.image.load('gallary/sprites/message.jpg').convert_alpha()
    GAME_SPRITES['base'] = pygame.image.load('gallary/sprites/ground.png').convert_alpha()
    GAME_SPRITES['pipe'] = (pygame.transform.rotate(pygame.image.load(PIPE).convert_alpha(), 180),
                            pygame.image.load(PIPE).convert_alpha()
                            )

    # Game sounds
    GAME_SOUNDS['die'] = pygame.mixer.Sound('gallary/audio/sfx_die.wav')
    GAME_SOUNDS['hit'] = pygame.mixer.Sound('gallary/audio/sfx_hit.wav')
    GAME_SOUNDS['point'] = pygame.mixer.Sound('gallary/audio/sfx_point.wav')
    GAME_SOUNDS['swoosh'] = pygame.mixer.Sound('gallary/audio/sfx_swooshing.wav')
    GAME_SOUNDS['wing'] = pygame.mixer.Sound('gallary/audio/sfx_wing.wav')
